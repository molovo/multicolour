 ...
 *    ComparativeString path to a value in the request object to constrain by,
 *    string format is ([comparative? ]object.path)
    ...
    Object.keys(this.rules).forEach(key => {
      ...
      if (constraint instanceof Function) {
        query[key] = deprecate(
          ...
          /* eslint-disable */
          // ESLint disabled because this message is too long. Only around for 2 minor versions.
          "Function constraints were deprecated in 0.4.8. They will continue to function until version 0.6.0. Please write your own handler."
          /* eslint-enable */
        )()
      }
      else {
