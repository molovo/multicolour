  ...
  compile() {
    ...
    Object.keys(this.rules).forEach(key => {
      ...
      if (typeof constraint === "undefined") {
        ...
        if (constraint.hasOwnProperty("value") && constraint.compile)
          parts = this.value_from_value(constraint.value)
        else if (constraint.hasOwnProperty("value") && !constraint.compile)
