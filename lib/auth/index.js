...
module.exports = App => {
  ...
  const user_model = require('./blueprint')(App)
  ...
  // Get the module.
  let auth_module = require(module_name)(App, user_model)
  ...
  App.server.route([
    {
      ...
      config: {
        ...
        notes: format('Using the "%s" scheme to create a session.', App.config.auth.provider),
        tags: [ 'api', 'session' ],
        validate: {
          payload: {
