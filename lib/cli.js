...
class cli extends Map {
  ...
  create_config_js_file(answers) {
    ...
    user_config.content = `${target}/content`
    user_config.auth = {
  ...
  _deal_with_init_answers(answers) {
    ...
    // We should encourage users to remove the . from the
    // file name so that it is visible in most operating
    // systems and they can edit the script themselves
    // but for now, convenience over spurious file generation.
