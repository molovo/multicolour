  ...
  constructor() {
    ...
    this.program
      ...
      .on("--help", () => {
        ...
        console.log()
        console.log("    multicolour plugin-add auth-oauth - will install multicolour-auth-oauth")
        console.log("    multicolour plugin-add my-awesome-plugin --no-prefix - will install my-awesome-plugin")
  ...
  ask_for_default_user(target) {
    ...
    .then(answers => {
      fs.readFile(require.resolve("../init/default-user.js"), (err, stream) => {
        ...
        mkdirp(`${target}/content/plugins/`, err => {
          if (err) throw err
          /* eslint-disable */
          fs.writeFile(`${target}/content/plugins/default-user.js`, file, err => {
            if (err) throw err
          })
          /* eslint-enable */
        })
