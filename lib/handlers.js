...
class Multicolour_Route_Templates {
  ...
  POST(model, request, callback) {
    ...
    if (model.constraints && model.constraints.post) {
      const constraints = this.compile_constraints.call(model, request, model.constraints.post)
  ...
  GET(model, request, callback) {
    ...
    if (model.constraints && model.constraints.get) {
      const constraints = this.compile_constraints.call(model, request, model.constraints.get)
  ...
  PATCH(model, request, callback) {
    ...
    if (model.constraints && model.constraints.patch) {
      const constraints = this.compile_constraints.call(model, request, model.constraints.patch)
  ...
  PUT(model, request, callback) {
    ...
    if (model.constraints && model.constraints.put) {
      const constraints = this.compile_constraints.call(model, request, model.constraints.put)
  ...
  DELETE(model, request, callback) {
    ...
    if (model.constraints && model.constraints.delete) {
      const constraints = this.compile_constraints.call(model, request, model.constraints.delete)
